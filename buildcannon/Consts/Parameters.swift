...
class Parameter {
    ...
    static let topShelfProvisioningProfile = Parameter.init(name: "top-shelf-provisioning-profile", type: DoubleDashComplexParameter.self)
    ...
    static let topShelfBundleIdentifier = Parameter.init(name: "top-shelf-bundle-identifier", type: DoubleDashComplexParameter.self)
